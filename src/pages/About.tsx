          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-700 mb-6">
                  Under the leadership of Bishop Fred Akama, our ministry has grown from a small fellowship to a thriving church family committed to excellence in worship, teaching, and service. We are passionate about seeing lives transformed and destinies fulfilled.
                </p>
                <p className="text-lg text-gray-700 mb-6">
